...
export class NavService {
	...
	MENUITEMS: Menu[] = [
		{ path: '/ucx/welcome', icon: 'home', title: 'Home', type: 'link' },
		{
			path:'',title:'Profile' , active: false, icon: 'user', type:'sub', children: [
				{ path: '/ucx/mycompany', title: 'Show Profile', type: 'link' },
				{ path: '/ucx/mycompany', title: 'Edit Profile', type: 'link' },
				{ path: '/ucx/insert-investment-file/individual', title: 'Add Investor Profile', type: 'link' },
			]
		},
		{
			path:'',title:'Investee Tools' , active: false, icon: 'menu', type:'sub', children: [
                { path: '/ucx/insert-company', title: 'Add Company', type: 'link' },
				{ path: '/ucx/companies/my', title: 'My Companies', type: 'link' },
				{ path: '/ucx/interests', title: 'Investors Interests', type: 'link' },
				{ path: '/ucx/investors', title: 'Investors List', type: 'link' },
				{ path: '/ucx/advisors', title: 'Advisors List', type: 'link' },
				{ path: '/ucx/under-construction', title: 'Request Services', type: 'link' },
				// { path: '/ucx/companies', title: 'Companies List', type: 'link' },
				// { path: '/ucx/watchlist', title: 'Watchlist', type: 'link' },
				{ path: '/ucx/search', title: 'Advanced Search', type: 'link' },
			]
		},
		{
			path:'',title:'Investor Tools' , active: false,icon: 'users', type:'sub', children: [
				{ path: '/ucx/insert-investment-file/institutional', title: 'Add Investor', type: 'link' },
				{ path: '/ucx/investors/my', title: 'My Investors', type: 'link' },
				{ path: '/ucx/companies', title: 'Investee List', type: 'link' },
				{ path: '/ucx/companies/my/interest', title: 'Interest List', type: 'link' },
				{ path: '/ucx/watchlist', title: 'Investee Watchlist', type: 'link' },
				// { path: '/ucx/watchlist', title: 'Manage Interests', type: 'link' },
				// { path: '/ucx/investors', title: 'Investors List', type: 'link' },
				// { path: '/ucx/search', title: 'Advanced Search', type: 'link' },
		]
		},
		{
			path:'',title:'Advisor' , active: false, icon: 'award', type:'sub', children: [
				{ path: '/ucx/advisor/add', title: 'Add Advisor', type: 'link' },
				{ path: '/ucx/advisors', title: 'Advisors List', type: 'link' },
				{ path: '/ucx/myAdvisors', title: 'My Advisors', type: 'link' },
				// { path: '/ucx/search', title: 'Advanced Search', type: 'link' },
		]
		},

		// {
		// 	title: 'UCX', icon: 'home', type: 'sub', badgeType: 'primary', badgeValue: 'new', active: false, children: [
		// 		{ path: '/ucx/welcome', title: 'Welcome', type: 'link' },
		// 		{ path: '/ucx/mycompany', title: 'Your Company', type: 'link' },
		// 		{ path: '/ucx/companies', title: 'All Companies', type: 'link' },
		// 		{ path: '/ucx/investors', title: 'All Investors', type: 'link' },
		// 	]
		// },
		// {
